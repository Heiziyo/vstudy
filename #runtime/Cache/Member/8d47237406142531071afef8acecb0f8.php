			...
			<div class="navbar-header pull-right">
				<div class="navbar-account">
					<ul class="account-area">
						...
						<li>
							<a href="<?php echo U('User/setBindSNS');?>">
						...
						<li>
							<a href="<?php echo U('User/record');?>">
								<i class="ace-icon fa fa-wrench"></i>
								操作记录
							</a>
						</li>
						<li>
							<a href="<?php echo U('User/realName');?>">
    ...
    <div class="col-xs-12">
        ...
        <div class="video-con center">
            ...
            <div id="progress">
                ...
                <form class="form-horizontal" role="form"  method="post" action="<?php echo U('addMyVideo');?>" id="mybox">
...
<script>
    $(".course").bind("change",function(){
        var cid = $(this).val();
        var url = "<?php echo U('getCourseChapter');?>";
        $.get(url,{cid:cid},
                function(data){
                    $('.chapter').nextAll().remove();
                    $('.chapter').after(data.data);
                })
    })
</script>
			</div>
