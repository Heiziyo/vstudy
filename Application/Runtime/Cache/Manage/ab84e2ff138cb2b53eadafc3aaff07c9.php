					...
					<form class="form-horizontal" role="form" onsubmit="return false" >
						<div class="form-group">
							...
							<div class="col-sm-10 col-xs-12">
								<input type="text" class="form-control" id="firstname" placeholder="请输入视频名称">
							</div>
						</div>
						<div class="form-group">
							<label for="name" class="col-sm-2">讲师</label>
							<select class="col-sm-10 col-xs-12" id="select-teacher">
								<option value="0">请选择分类</option>
							</select>
						</div>
						<div class="form-group">
							<label for="name" class="col-sm-2">视频简介</label>
							<textarea class="col-sm-10 col-xs-12" rows="3" style="max-width: 100%;"></textarea>
						</div>
						<div class="form-group">
							<label for="name" class="col-sm-2">分类</label>
							<select class="col-sm-10 col-xs-12" id="select-type">
								<option value="0">请选择分类</option>
								<?php if(is_array($gettype)): $i = 0; $__LIST__ = $gettype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["c_id"]); ?>"><?php echo ($vo["c_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
						<div class="form-group">
							<label for="name" class="col-sm-2">方向</label>
							<select class="col-sm-10 col-xs-12" id="select-fx">
...
<script>
	var uploader= new plupload.Uploader({
		...
		filters : {
			max_file_size : '1000G',
			mime_types: [
				{title : "Video", extensions : "mp4,wmv"},
			]
		},
...
<script>
	$(function () {
		$("#select-type").change(function () {
				...
				$.get('getChildType',{pid:pid},function (data) {
