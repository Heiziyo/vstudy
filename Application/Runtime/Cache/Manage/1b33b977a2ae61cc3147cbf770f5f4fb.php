	...
	$(function () {
		$("#course-add").on("click",function(){
			...
			if(addCourse==""){
				...
				$(".add-course-list").append("<li class='course-li'><input type='text' name='course_chapter[]'  value="+addCourse+"><i class='glyphicon glyphicon-remove course-del'></i></li>");
				$(".course-tips").text("");
			};
		});

		$(".add-course-list").on("click",".course-del", function() {
			$(this).parents(".course-li").remove();
		});
