...
<body>
    ...
    <!--Jquery Select2-->
    <script src="/Public/member/assets/js/select2/select2.js"></script>
    <!--Bootstrap Tags Input-->
    <script src="/Public/member/assets/js/tagsinput/bootstrap-tagsinput.js"></script>

    <!--Bootstrap Date Picker-->
    <script src="/Public/member/assets/js/datetime/bootstrap-datepicker.js"></script>

    <!--Bootstrap Time Picker-->
    <script src="/Public/member/assets/js/datetime/bootstrap-timepicker.js"></script>

    <!--Bootstrap Date Range Picker-->
    <script src="/Public/member/assets/js/datetime/moment.js"></script>
    <script src="/Public/member/assets/js/datetime/daterangepicker.js"></script>

    <!--Jquery Autosize-->
    <script src="/Public/member/assets/js/textarea/jquery.autosize.js"></script>

    <!--Fuelux Spinner-->
    <script src="/Public/member/assets/js/fuelux/spinner/fuelux.spinner.min.js"></script>

    <!--jQUery MiniColors-->
    <script src="/Public/member/assets/js/colorpicker/jquery.minicolors.js"></script>

    <!--jQUery Knob-->
    <script src="/Public/member/assets/js/knob/jquery.knob.js"></script>

    <!--noUiSlider-->
    <script src="/Public/member/assets/js/slider/jquery.nouislider.js"></script>

    <!--jQRangeSlider-->
    <script src="/Public/member/assets/js/jquery-ui-1.10.4.custom.js"></script>
    <script src="/Public/member/assets/js/slider/jQRangeSlider/jQAllRangeSliders-withRuler-min.js"></script>
