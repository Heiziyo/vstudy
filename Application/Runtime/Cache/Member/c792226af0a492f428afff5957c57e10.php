...
<head>
    ...
    <link href="/Public/member/assets/css/bootstrap-rtl.min.css" rel="stylesheet" />
    ...
    <link href="http://fonts.useso.com/earlyaccess/droidarabickufi.css" rel="stylesheet" type="text/css" />

    <!--Beyond styles-->
    <link href="/Public/member/assets/css/beyond-rtl.min.css" rel="stylesheet" />
    <link href="/Public/member/assets/css/4095-rtl.min.css" rel="stylesheet" type="text/css" />
            ...
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-right">
                    <a href="#" class="navbar-brand">
                        <small>
                            <img src="/Public/member/assets/img/logo-rtl.png" alt="" />
                        </small>
                    </a>
                </div>
                <!-- /Navbar Barnd -->
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox radius-bordered databox-shadowed databox-graded">
                                        <div class="databox-right no-padding bordered-left-2 bordered-palegreen">
                                            ...
                                            <div class="row">
                                                <div class=" col-lg-1 col-md-1 col-sm-6 col-xs-12">
                                                    <a class="day-container" href="">
                                                        ...
                                                        <div class="month">شوال</div>
                                                    </a>
                                                </div>
                                                <div class=" col-lg-1 col-md-1 col-sm-6 col-xs-12">
                                                    <a class="day-container" href="">
                                                        <div class="day">15</div>
                                                        <div class="month">رجب</div>
                                                        <b class="day-pin"></b>
                                                    </a>
                                                </div>
                                                <div class=" col-lg-1 col-md-1 col-sm-6 col-xs-12">
                                                    <a class="day-container highlight" href="">
                                                        ...
                                                        <div class="month">رمضان</div>
                                                    </a>
                                                </div>
                                                <div class=" col-lg-1 col-md-1 col-sm-6 col-xs-12">
                                                    <a class="day-container" href="">
                                                        <div class="day">09</div>
                                                        <div class="month">شعبان</div>
                                                    </a>
                                                </div>
                                                <div class=" col-lg-1 col-md-1 col-sm-6 col-xs-12">
                                                    <a class="day-container " href="">
                                                        <div class="day">14</div>
                                                        <div class="month">محرم</div>
                                                        <b class="day-pin"></b>
                                                    </a>
                                                </div>
                                                <div class=" col-lg-1 col-md-1 col-sm-6 col-xs-12">
                                                    <a class="day-container" href="">
                                                        ...
                                                        <div class="month">صفر</div>
                                                    </a>
                                                </div>
                                                <div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <a class="day-container all" href="">
                                                        <div class="day">1428</div>
                                                        <div class="month">ترى كل</div>
                                                        <span class="day-more">
                                                            <i></i>
                                                        </span>
                                                    </a>
                                                ...
                                                <div class="tickets-container">
                                                    <ul class="tickets-list">
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/Public/member/assets/img/avatars/adam-jansen.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/Public/member/assets/img/avatars/divyia.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/Public/member/assets/img/avatars/Matt-Cheuvront.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/Public/member/assets/img/avatars/Sergey-Azovskiy.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/Public/member/assets/img/avatars/John-Smith.jpg" class="user-avatar">
