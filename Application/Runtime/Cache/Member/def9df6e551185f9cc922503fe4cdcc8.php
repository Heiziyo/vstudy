...
<body>
    ...
    <script src="/Public/member/assets/js/editors/wysiwyg/jquery.hotkeys.js"></script>
    <script src="/Public/member/assets/js/editors/wysiwyg/prettify.js"></script>
    <script src="/Public/member/assets/js/editors/wysiwyg/bootstrap-wysiwyg.js"></script>
    <script>
        $(function () {
    ...
    <!--Summernote Scripts-->
    <script src="/Public/member/assets/js/editors/summernote/summernote.js"></script>
    <script>
