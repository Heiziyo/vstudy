...
<div class="container-center">
	...
	<div class="header header2">
		<div class="header-left">
			<div class="logo">
				<a href="index.html"><img src="/Public/images/logo2.png" /></a>
			</div>
			<ul class="mynav">
					...
					<div class="course-nav-row clearfix">
						...
						<div class="bd">
							<ul class="">
								...
								<?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li class="course-nav-item">
									<a href="'index/demo?id=<?php echo ($list["c_id"]); ?>" data-ct="fe"><?php echo ($list["c_name"]); ?></a>
